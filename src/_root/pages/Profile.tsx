        ...
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
          ...
          <div className="flex flex-col flex-1 justify-between md:mt-2">
            ...
            <div className="flex gap-8 mt-10 items-center justify-center xl:justify-start flex-wrap z-20">
              ...
              <StatBlock value={20} label="Abonnés" />
              <StatBlock value={20} label="Abonnements" />
            </div>
            {currentUser.videoId && (
              <div className=" mt-8 w-full flex justify-center items-center">
                <video
                  src={`https://cloud.appwrite.io/v1/storage/buckets/${appwriteConfig.storageId}/files/${currentUser.videoId}/view?project=${appwriteConfig.projectId}&project=${appwriteConfig.projectId}&mode=admin`}
                  autoPlay
                  controls
